      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 space-y-3">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            Koristimo nužne kolačiće za rad stranice te, uz vaš pristanak, obrađujemo podatke iz kontakt obrasca radi odgovora na upit. Više u <Link href="/privatnost" className="font-medium text-primary underline-offset-4 hover:underline">politici privatnosti</Link>.
          </p>
