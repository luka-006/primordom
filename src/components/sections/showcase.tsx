      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-12 md:grid-rows-2">
          <motion.div style={{ y: y1 }} className="relative aspect-[4/3] overflow-hidden rounded-2xl md:col-span-7 md:row-span-2 md:aspect-auto md:min-h-[420px]">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent" /><p className="absolute bottom-4 left-4 text-sm font-medium text-white">Vile i apartmani</p>
          </motion.div>
          <motion.div style={{ y: y2 }} className="relative aspect-[16/10] overflow-hidden rounded-2xl md:col-span-5">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent" /><p className="absolute bottom-4 left-4 text-sm font-medium text-white">Jahte i brodovi</p>
          </motion.div>
          <motion.div style={{ y: y1 }} className="relative aspect-[16/10] overflow-hidden rounded-2xl md:col-span-5">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent" /><p className="absolute bottom-4 left-4 text-sm font-medium text-white">Soboslikanje</p>
          </motion.div>
        </div>
      </div>
    </section>
